...
namespace AspMvcFirstTask.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult GetById(string id) =>
            View("ShowById",ProductDb.products.FirstOrDefault(product=>product.Id.ToString()==id));
        ...
        public ActionResult GetByPrice(int price) =>
            View("ShowByPrice", ProductDb.products.Where(product => (int)product.Price==price));
    }
}
